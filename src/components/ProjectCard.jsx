      ...
      >
        ...
        <div className="p-6 flex flex-col flex-grow relative">
          ...
          <button
            ...
            className="relative z-10 mt-4 w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 hover:border-ai-accent/50 hover:bg-white/10 text-xs font-mono text-text-secondary hover:text-white transition-all"
          >
            <span className="material-symbols-outlined text-sm text-ai-accent">chat</span>
            Ask about this project
          </button>
        </div>
      </div>
      {chatOpen && (
        <ProjectChatModal project={project} onClose={() => setChatOpen(false)} />
      )}
    </>
  );
}
