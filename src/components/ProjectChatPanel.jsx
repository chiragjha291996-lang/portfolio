...
function ProjectChatPanel({ project, showHeader = true, onClose }) {
  ...
  return (
    <div className="flex flex-col overflow-hidden flex-1 min-h-0">
      {showHeader && (
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-surface-darker/90 backdrop-blur-md shrink-0">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] font-mono text-text-secondary">Ask about the chosen project</p>
            </div>
          </div>
          {onClose && (
            <button
              onClick={onClose}
              className="p-1 rounded-lg hover:bg-white/10 transition-colors text-text-secondary hover:text-white shrink-0"
            >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 min-h-0">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center min-h-[200px] gap-4 text-center px-2">
      ...
      <form onSubmit={handleSubmit} className="px-3 py-3 border-t border-white/10 bg-surface-darker/90 backdrop-blur-md shrink-0">
